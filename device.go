...
type deviceHandler struct {
	...
	peripheralDiscovered func(p Peripheral, a *Advertisement, rssi int, scanResponse bool)
...
func PeripheralDiscovered(f func(Peripheral, *Advertisement, int, bool)) Handler {
